...
def main(args):
    ...
    all_loader = graph_dataset_loader(graph_feats, all_nets_index, ind_labels, state_labels, batch_size)
    ...
    for _ in range(epochs):
        ...
        if val_accuracy > best_val_accuracy:
            ...
            state_save_dir = "./Genderind_{}_uni_weight/".format(contrast)
            os.makedirs(state_save_dir, exist_ok=True)
            torch.save((model.nets+model.nets.transpose(1, 2))/2, f'./{net_type}_adj_mat{args.num_edges}.pth')
